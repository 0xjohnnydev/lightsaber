...
async function _aarw_main() {
    ...
    const {_make_stage1} = (() => {
        ...
        // Keep these allocations below JavaScript's 32-bit shift wrap point.
        // Use 8 MiB and 16 MiB allocations on iPhone17,2 to trigger GC
        // without crossing the WebContent memory high-water limit.
        let grbase = 17;
            ...
            for (let i = 0; i < N; ++i) {
                try {
                    ...
                    if (i === 0 || i === N - 1 || (i + 1) % 10 === 0) {
                        print(`[stage1] unit ${i + 1}/${N} failed: ${e && e.stack ? e.stack : e}`);
                    }
                }
            }
            throw new TryAgainError(`stage1 unit retries exhausted: ${lastError && lastError.stack ? lastError.stack : lastError}`);
        }
